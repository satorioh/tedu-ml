...
# 构建随机森林
model = ensemble.RandomForestRegressor(max_depth=10, n_estimators=1000, random_state=7)  # n_estimators：弱学习器数量
...
"""
训练集MSE： 1.9286883297647037
测试集MSE： 15.191884752784656
训练集R2： 0.9773976449489322
测试集R2： 0.8119961902031213
"""
